...
mod tests {
    ...
    use crate::{
        ...
        message::{ResponseType, ZeroMessage},
    };
    ...
    fn test_get_file_response_and_body() {
        ...
        assert!(res.is_ok());
        let bytes = [
            133, 163, 99, 109, 100, 168, 114, 101, 115, 112, 111, 110, 115, 101, 162, 116, 111, 0,
            164, 98, 111, 100, 121, 196, 1, 48, 168, 108, 111, 99, 97, 116, 105, 111, 110, 0, 164,
            115, 105, 122, 101, 1,
        ];
        ...
        let bytes = [
            131, 164, 98, 111, 100, 121, 196, 1, 48, 168, 108, 111, 99, 97, 116, 105, 111, 110, 0,
            164, 115, 105, 122, 101, 1,
        ];
        assert_eq!(res.unwrap(), bytes);
    }
    ...
    fn test_announce() {
        ...
        let bytes = vec![
            131, 163, 99, 109, 100, 168, 97, 110, 110, 111, 117, 110, 99, 101, 166, 112, 97, 114,
            97, 109, 115, 136, 163, 97, 100, 100, 146, 165, 111, 110, 105, 111, 110, 164, 105, 112,
            118, 52, 166, 100, 101, 108, 101, 116, 101, 195, 166, 104, 97, 115, 104, 101, 115, 147,
            220, 0, 32, 89, 112, 7, 110, 204, 192, 204, 202, 204, 246, 204, 172, 204, 153, 204,
            204, 68, 17, 204, 131, 21, 113, 111, 125, 39, 66, 204, 195, 91, 53, 41, 204, 172, 78,
            204, 234, 204, 146, 204, 138, 48, 204, 150, 109, 29, 220, 0, 32, 29, 204, 193, 204,
            202, 204, 145, 204, 155, 127, 204, 205, 204, 249, 204, 222, 204, 181, 121, 80, 204,
            223, 86, 204, 149, 204, 175, 49, 204, 199, 10, 204, 242, 204, 237, 120, 204, 239, 204,
            250, 84, 204, 225, 204, 196, 19, 67, 54, 74, 31, 220, 0, 32, 204, 154, 94, 94, 204,
            135, 80, 65, 204, 245, 204, 232, 204, 228, 204, 170, 204, 254, 51, 204, 215, 25, 204,
            155, 204, 238, 32, 204, 182, 95, 83, 204, 131, 204, 168, 204, 192, 125, 22, 53, 43,
            204, 147, 91, 204, 235, 29, 204, 146, 168, 110, 101, 101, 100, 95, 110, 117, 109, 20,
            170, 110, 101, 101, 100, 95, 116, 121, 112, 101, 115, 145, 164, 105, 112, 118, 52, 175,
            111, 110, 105, 111, 110, 95, 115, 105, 103, 110, 95, 116, 104, 105, 115, 160, 171, 111,
            110, 105, 111, 110, 95, 115, 105, 103, 110, 115, 144, 164, 112, 111, 114, 116, 205, 60,
