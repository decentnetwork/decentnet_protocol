...
mod tests {
    ...
    fn test_pack_onionv3() {
        ...
        assert_eq!(
            packed,
            [
                156, 64, 37, 15, 183, 66, 15, 188, 254, 248, 173, 85, 140, 233, 190, 234, 200, 120,
                101, 0, 194, 95, 124, 200, 20, 219, 44, 33, 89, 100, 93, 226, 56, 153, 3, 225, 16
            ]
        );
        assert_eq!(unpacked.to_string(), address_string);
    }
    ...
    fn test_pack_i2pb32() {
        ...
        assert_eq!(
            packed,
            [
                160, 206, 56, 206, 34, 36, 210, 206, 202, 249, 146, 147, 136, 247, 51, 121, 37,
                156, 12, 39, 224, 222, 189, 189, 124, 164, 205, 8, 91, 85, 226, 90, 225, 16
            ]
        );
        assert_eq!(unpacked.to_string(), address_string);
    }
